...
public class OrderPaymentCreatedConsumerHandler(IOrderPaymentRepository repository, IConnectionFactory busFactory) : BackgroundService
{
    ...
    {
        //TODO ajustar para ficar consumindo em loop da fila.
        ...
        await channel.QueueDeclareAsync(QueueName, durable: Durable, exclusive: Exclusive, autoDelete: AutoDelete, arguments: _arguments, cancellationToken: cancellationToken);
